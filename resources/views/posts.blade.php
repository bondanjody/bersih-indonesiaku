    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            ...
            <div class="card-body">
                ...
                <p><small class="text-muted">by. <a href="/authors/{{ $posts[0]->author->username }}" class="text-decoration-none">{{ $posts[0]->author->name }}</a> {{ $posts[0]->created_at->diffForHumans() }}</small></p>
